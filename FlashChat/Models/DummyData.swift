...
final internal class DummyData {
    let chat: [Message] = [Message(isMyMessage: true, message: "Hi!", time: "11:00"),
                           ...
                           Message(isMyMessage: true, message: """
                                   ...
                                   Qui voluptatibus dolores ex vero cumque qui provident
consectetur sed tempore omnis sed exercitationem
similique et fugiat repellendus!
Sit nulla ipsum ut repudiandae
assumenda eum sint dignissimos.
 Nam temporibus dolorum es
t commodi exercitationem ex ipsa od
it sed tempora provident.
""", time: "11:07"),
